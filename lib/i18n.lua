...
local zh = {
    ...
    ["Clear cache for \"%1\"? Downloaded content and the cover thumbnail will be deleted."] = "清除「%1」的缓存？已下载内容和封面缩略图将被删除。",
    ...
    ["Cache cleared"] = "缓存已清除",
    ["Clear cover cache"] = "清除封面缓存",
    ["Failed to clear cover cache"] = "清除封面缓存失败",
    ["Cover cache cleared (%1 file(s))"] = "封面缓存已清除（%1 个文件）",
    ["Cover cache is empty"] = "封面缓存为空",
    ["Clear cover cache? %1 cover file(s) (about %2) will be deleted."] = "清除封面缓存？将删除 %1 个封面文件（约 %2）。",
    ["[Cleanup] Clear cover cache (%1)"] = "【清理】清除封面缓存（%1）",
    ["empty"] = "空",
